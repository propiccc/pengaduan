...
<body>
    <div class="bg-gray-900 scrollbar-none flex overflow-scroll min-h-screen max-h-screen">
        
        {{-- Menu Start --}}
        <div class="bg-gray-900 w-[350px] flex flex-col text-white">
            <a href="{{'/'}}" class="bg-gray-900 h-[70px] text-3xl font-semibold flex items-center justify-center text-white">
                E-<span class="text-white">Aduin</span>
            </a>
            <div class="bg-gray-900 flex flex-col h-full overflow-scroll scrollbar-none px-3 py-5 gap-y-2 text-white">
                    <a href="{{route('admin.dashboard')}}" class="w-full  min-h-[50px] flex items-center justify-center font-semibold text-xl rounded-md cursor-pointer {{request()->path() == 'admin/dashboard' ? 'bg-white text-black' : 'bg-transparent text-white'}}">Dashboard</a>
                    <a href="{{route('user.index')}}" class="w-full  min-h-[50px] flex items-center justify-center font-semibold text-xl rounded-md cursor-pointer {{request()->path() == 'admin/user' || request()->path() == 'admin/user/create' || Request::is('admin/user/*/edit')  || request()->path() == 'admin/user/search' ? 'bg-white text-black' : 'bg-transparent text-white'}}">User</a>
        ...
        <div class="bg-gray-900 w-full flex flex-col">
            {{-- Navbar Start --}}
             <div class="bg-gray-900 h-[70px] flex items-center justify-end px-5 gap-x-2">
            ...
            {{-- Navbar End --}}
            <div class="bg-gray-700 h-full p-10 overflow-hidden">
